...
//     version 1.14.2
//     from Assets/__WatermelonGame/4.Input/WatermelonGame.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/__WatermelonGame/4.Input/WatermelonGame.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        {
            ""name"": ""Default"",
            ""id"": ""5ba950ca-c7ed-4f56-aea0-25004ff8843a"",
            ""actions"": [
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""827bc2bf-b118-450d-9540-1e12486338d8"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""1dfec114-af0f-4da8-9df6-ff22afb65dc0"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6005d060-46a3-4b6b-a0e2-3abc17c45019"",
    ...
    ""controlSchemes"": []
        ...
        ~@InputModule()
        {
            UnityEngine.Debug.Assert(!m_Default.enabled, "This will cause a leak and performance issues, InputModule.Default.Disable() has not been called.");
        }
        ...
        public struct DefaultActions
        {
            ...
            /// </summary>
            public DefaultActions(@InputModule wrapper) { m_Wrapper = wrapper; }
            /// <summary>
